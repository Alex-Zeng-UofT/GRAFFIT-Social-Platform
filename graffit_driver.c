...
int main()
{
    ...
    print_friends(mustafa);
    if (!in_friend_list(mustafa->friends, brian) || !in_friend_list(mustafa->friends, william)||num_friends(mustafa)!=3)
    {
